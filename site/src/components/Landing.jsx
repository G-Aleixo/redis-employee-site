      ...
      <div className="row m-0 p-0 g-0">
        <div className="col-12 m-0 p-0">
          ...
          >
            ...
            />
            <label
              className="btn btn-outline-primary rounded-bottom-0 rounded-top-0 flex-fill border-bottom-0"
            ...
            />
            <label
              className="btn btn-outline-danger rounded-bottom-0 rounded-top-0 flex-fill border-bottom-0"
              htmlFor="selectRedis"
              style={{ width: "50%" }}
            >
              Redis
