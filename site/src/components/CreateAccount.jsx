        ...
        <div className="row justify-content-center">
          <div className="col-md-5 py-3">
            <div className="input-group">
              ...
              <input type="text" className="form-control" name="username" placeholder="Digite seu nome" required></input>
          ...
          <div className="col-md-2 py-3">
            <div className="input-group">
              ...
              <input type="number" className="form-control" name="age" placeholder={0} min={0} max={100} required></input>
              <div className="invalid-feedback">
        ...
        <div className="row justify-content-center">
          <div className="col-md-3 py-3">
            <div className="input-group">
              ...
              <input type="password" className="form-control" name="password" placeholder="Digite sua senha" required></input>
              <div className="invalid-feedback">
          ...
          <div className="col-md-4 py-3">
            <div className="input-group">
              ...
              <input className="form-control" name="favorite_team" list="datalistOptions" placeholder="Nome do seu time favorito" value={favTeam.firts} onChange={(e) => setFavTeam(prev => ({ ...prev, firts: e.target.value }))} onBlur={() => setFavTeam(prev => ({ ...prev, firts: "América Natal - RN", second: "América Natal - RN" }))} />
        ...
        <div className="row justify-content-center pb-5 pt-3">
          <div className="col-md-7">
            <div className="input-group display-flex">
              ...
              <textarea className="form-control" name="information" aria-label="Withtextarea" placeholder="Fale sobre você... opcional" style={{}}></textarea>
            </div>
          </div>
        </div>
